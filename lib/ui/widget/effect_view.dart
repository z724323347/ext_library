...
enum TweenProperty { opacity, scale, xOffset, yOffset, angle }
...
class EffectView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tween = MovieTween()
      ..tween(TweenProperty.opacity, Tween(begin: opacity, end: 1.0),
          duration: duration, curve: curve)
      ..tween(TweenProperty.scale, Tween(begin: scale, end: 1.0),
          duration: duration, curve: curve)
      ..tween(TweenProperty.xOffset, Tween(begin: xOffset, end: 0.0),
          duration: duration, curve: curve)
      ..tween(TweenProperty.yOffset, Tween(begin: yOffset, end: 0.0),
          duration: duration, curve: curve)
      ..tween(TweenProperty.angle, Tween(begin: angle, end: 0.0),
          duration: duration, curve: curve);
