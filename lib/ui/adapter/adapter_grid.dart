...
/// A GridView with adapter capabilities.
///
/// AdapterGridView extends [GridView] with
/// a custom [AdapterGridDelegate] [gridDelegate]
/// that adds more grid layout controls.
/// See [AdapterGridDelegate] for shrink and
...
class AdapterGridView extends StatelessWidget {
  ...
  final AdapterGridDelegate gridDelegate;
...
class _AdapterGridViewLayout extends BoxScrollView {
  final AdapterGridDelegate gridDelegate;
  final SliverChildDelegate childrenDelegate;
  final int? itemCount;

  const _AdapterGridViewLayout({
    Key? key,
...
class AdapterGridDelegate extends SliverGridDelegate {
  const AdapterGridDelegate({
  ...
  @override
  bool shouldRelayout(AdapterGridDelegate oldDelegate) {
